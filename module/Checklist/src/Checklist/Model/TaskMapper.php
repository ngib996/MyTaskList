...
class TaskMapper
{
	...
	public function fetchAll()
	{
		...
		$hydrator = new ClassMethods();       //The hydrator is an object that knows how to populate an entity. 
		$resultset = new HydratingResultSet($hydrator, $entityPrototype);  // the ClassMethods hydrator which expects a getter and a setter method for each column in the resultset
